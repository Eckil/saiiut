...
<br><br>
<br><br>
<form action ="{{route('guardaAspirantes')}}" method = 'POST' id="formulario" onsubmit="return validacion()">
{{csrf_field()}}


Nombre aspirante: <br>
	<input id="nAspirante" name="nAspirante" type="text" onblur="fieldSizeNom()">
	<br>
	<p id="errorNom"></p>
apellido paterno: <br>
	<input id="apAspirante" name="apAspirante" type="text"  onblur="fieldSizeApp()">
	<br>
	<p id="errorApp"></p>

apellido materno: <br>
	<input id="amAspirante" name="amAspirante" type="text"  onblur="fieldSizeApm()">
	<br>
	<p id="errorApm"></p>

sexo: <br>
	
	<input id="sexo" name="sexo" type="radio"  value="Femenino" >
...
Pais de origen: <br>
	<input id="paisOrigen" name="paisOrigen" type="text"  onblur="fieldSizePais()">
	<br>
	<p id="errorPais"></p>

Estado civil: <br>
<select class="form-control" id="EstadoCivil" name="EstadoCivil" onchange="fieldSizeCivil()">
		...
		<p id="errorCivil"></p>
CURP: <br>
	<input id="CURP" name="CURP" type="text"  onblur="fieldSizeCURP()" oninput="actualizarRFC()">
	<br>
	<p id="errorCURP"></p>

RFC: <br>
	<input id="RFC" name="RFC" type="text" maxlength="10" >
	<br>
	

Peso: <br>
	<input id="peso" name="peso" type="text"  onblur="fieldSizePeso()">kg
	<br>
	<p id="errorPeso"></p>

Estatura: <br>
	<input id="estatura" name="estatura" type="text"  onblur="fieldSizeEsta()">
	<br>
	<p id="errorEsta"></p>
...
famDiabetico: <br>
	<select class="form-control" id="famDiabetico" name="famDiabetico" onchange="fieldSizefamD()">
...
famHipertenso: <br>
	<select class="form-control" id="famHipertenso" name="famHipertenso" onchange="fieldSizefamH()">
...
famCardiaco: <br>
	<select class="form-control" id="famCardiaco" name="famCardiaco" onchange="fieldSizefamC()">
...
ceneval: <br>
	<input id="ceneval" name="ceneval" type="text" onblur="fieldSizeCene()">
	<br>
	<p id="errorCene"></p>

folioInt: <br>
	<input id="folioInt" name="folioInt" type="text" onblur="fieldSizeFoli()">
	<br>
	<p id="errorFoli"></p>

estadoProc: <br>
<select class="form-control" id="estadoProc" name="estadoProc" onchange="fieldSizeEstado()">
			<option id="estadoProc" value="0">--- Selecciona Estado ---</option>
...
munProc: <br>
<select class="form-control" id="munProc" name="munProc" onchange="fieldSizemunProc()">
			<option id="munProc" value="0">--- Selecciona Municipio ---</option>
...
escProcedencia: <br>
<select class="form-control" id="escProcedencia" name="escProcedencia" onchange="fieldSizeEscPro()">
			<option id="escProcedencia" value="0">--- Selecciona Escuela ---</option>
			@foreach($preparatorias as $prepa)
				<option value="{{$prepa->institucion}}">{{$prepa->institucion}}</option>
			@endforeach
		</select><br>
		<p id="errorEscProc"></p>

espProcedencia: <br>
	<input id="espProcedencia" name="espProcedencia" type="text"  onblur="fieldSizeEspP()">
	<br>
	<p id="errorEspP"></p>

anoIniProce: <br>
	<input id="anoIniProce" name="anoIniProce" type="text"  onblur="fieldSizeAnoIni()">
	<br>
	<p id="errorAnoIni"></p>

anoFinProce: <br>
	<input id="anoFinProce" name="anoFinProce" type="text"  onblur="fieldSizeAnoFin()">
	<br>
	<p id="errorAnoFin"></p>

promedioProce: <br>
	<input id="promedioProce" name="promedioProce" type="text"  onblur="fieldSizeProm()">
	<br>
	<p id="errorProm"></p>

nTutor: <br>
	<input id="nTutor" name="nTutor" type="text" onblur="fieldSizeNtut()">
	<br>
	<p id="errorNtut"></p>

apTutor: <br>
	<input id="apTutor" name="apTutor" type="text"  onblur="fieldSizeAptut()">
	<br>
	<p id="errorAptut"></p>

amTutor: <br>
	<input id="amTutor" name="amTutor" type="text"  onblur="fieldSizeAmtut()">
	<br>
	<p id="errorAmtut"></p>
