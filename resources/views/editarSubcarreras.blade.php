...
<head>
	...
	<title>Editar Subcarreras</title>
	<style>
		html, body {
...
<br><br>
<br><br>
<form action ="{{route('actualizarSubcarreras',$consulta->id)}}" method = 'POST' onsubmit="return validacion()">
	{{csrf_field()}}
	...
	<input id="nsubcarrera" name="nsubcarrera" type="text" value="{{$consulta->nsubcarrera}}" onblur="fieldSizeSubcarrera()">
	<br>
	<p id="errorSubcar"></p>
...
activo: <br>
	<input id="activo" name="activo" type="number" class="number" value="{{$consulta->activo}}" >
	<br>
	<p id="errorAct"></p>
